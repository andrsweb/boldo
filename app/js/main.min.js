(function (factory) {
	...
	menuButton.addEventListener('click', () => {
	  if (!menuBurger.classList.contains('active')) menuBurger.classList.add('active');else menuBurger.classList.remove('active');
	  if (!menuButton.classList.contains('active')) menuButton.classList.add('active');else menuButton.classList.remove('active');
	});
	/**
	...
	scrollHead.addEventListener('scroll', () => {
	  if (scrollHead > 0) scrollHead.classList.add('color');
	});
	...
	onArrowClickTop.addEventListener('click', () => {
	  if (!dropDownTop.classList.contains('show')) dropDownTop.classList.add('show');else dropDownTop.classList.remove('show');
	  if (!onArrowClickTop.classList.contains('up')) onArrClickTop.classList.add('up');else onArrClickTop.classList.remove('up');
	});
	...
	onArrowClickBot.addEventListener('click', () => {
	  if (!dropDownBot.classList.contains('show')) dropDownBot.classList.add('show');else dropDownBot.classList.remove('show');
	  if (!onArrowClickBot.classList.contains('down')) onArrowClickBot.classList.add('down');else onArrowClickBot.classList.remove('down');
	});
